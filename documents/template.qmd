...
This poster studies the same system we are studying, and all three of our main sites are likely in its dataset. NEC as East Channel, NPB as Phelps Bridge, and NVBR as Venoco Bridge. It also measures DO at two depths, which is the same idea behind our elevation codes 0 and 2, so it supports our stratification question and our Figures 2 and 3. We just use three elevation codes instead of two and add a more formal statistical workflow with Kruskal-Wallis and Dunn tests. The poster's biggest contribution is the ecological context our project does not cover, since it shows that ostracods dominate at low DO sites like Phelps Bridge while copepods dominate at higher DO sites near the mouth. We can cite this poster to argue that the DO differences we found across the three NCOS sites also matter biologically, not just statistically.
