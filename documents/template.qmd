...
This paper supplies the physical mechanism behind the project's second research question: why DO would differ vertically within a site. Devereux Slough is an ICOLL, so the system match is exact. It justifies using elevation codes as a stratification proxy.  And it helps explain why Venoco Bridge, the most ocean-influenced and likely most saline-stratified site, showed the clearest vertical DO gradient.
